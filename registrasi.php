...
<head>
    ...
    <title>Daftar - PengingatObat</title>
...
<body>
    ...
    <div class="auth-card">
        <div class="auth-logo">
            ...
            <p>Daftar sebagai pasien untuk mulai menggunakan PengingatObat</p>
        </div>
        ...
        <form action="proses/prosesRegistrasi.php" method="POST">
            <div class="mb-3">
                <label class="form-label"><i class="fa-solid fa-user me-1"></i>Nama Lengkap</label>
                <input type="text" name="nama_lengkap" class="form-control" placeholder="Masukkan nama lengkap" required>
            </div>
            <div class="mb-3">
                <label class="form-label"><i class="fa-solid fa-envelope me-1"></i>Email Aktif</label>
                <input type="email" name="email" class="form-control" placeholder="Masukkan email" required>
            </div>
            <div class="mb-3">
                <label class="form-label"><i class="fa-solid fa-at me-1"></i>Username</label>
            ...
            <button type="submit" class="btn-auth"><i class="fa-solid fa-user-check me-2"></i>Daftar Sekarang</button>
        </form>

        <div class="auth-footer">
            Sudah punya akun? <a href="views/login.php">Masuk di sini</a>
        </div>
    </div>
